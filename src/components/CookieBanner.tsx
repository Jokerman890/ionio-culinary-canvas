  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-4xl">
        <div className="bg-navy rounded-lg shadow-2xl border border-navy-light p-4 md:p-6 flex flex-col md:flex-row items-start md:items-center gap-4">
          {/* Icon & Text */}
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            <Button
              ...
              variant="gold"
              className="btn-animate flex-1 md:flex-none"
            >
              OK
            </Button>
            <Button
              variant="ghost"
              asChild
              className="text-primary-foreground/70 hover:text-gold hover:bg-transparent flex-1 md:flex-none"
            >
